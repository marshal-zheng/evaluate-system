          ...
          <a-list-item-meta>
            <template #avatar>
              <a-avatar shape="square" class="rounded-[var(--border-radius-mini)] bg-[var(--color-text-n9)]">
                ...
                <ZxIcon v-else type="iconfont" :icon="getFileIcon(item)" :size="24" class="text-[var(--color-text-4)]" />
              </a-avatar>
            </template>
            <template #title>
...
<script setup lang="ts">
  ...
  import { getFileIcon } from './iconMap.js';
